...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || HelpRequested(gArgs)) {
        ...
        std::string strUsage = PACKAGE_NAME " bitcoin-tx utility version " + FormatFullVersion() + "\n\n" +
            "Usage:  myriadcoin-tx [options] <hex-tx> [commands]  Update hex-encoded bitcoin transaction\n" +
            "or:     myriadcoin-tx [options] -create [commands]   Create hex-encoded bitcoin transaction\n" +
            "\n";
