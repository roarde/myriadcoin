...
public:
    CMainParams() {
        ...
        vSeeds.push_back(CDNSSeedData("myriadseed1.cryptapus.org", "myriadseed1.cryptapus.org")); // cryptapus
...
public:
    CTestNetParams() {
        ...
        vSeeds.push_back(CDNSSeedData("myriadtestseed1.cryptapus.org", "myriadtestseed1.cryptapus.org")); // cryptapus
